...
% Формат заголовков
\usepackage{titlesec}
\titleformat{\chapter}[hang]{\righthyphenmin62\sloppy\Large\bfseries}{\thechapter}{10pt}{} % righthypenmin62 - не переносить слова в названиях глав
...
\begin{document}
\includepdf[pages={1}]{title_repaired.pdf} % титульник
