...
\usepackage{etoolbox} % позволяет добавлять произвольный код в начало любой команды
...
%\newcommand{\spchapter}[1]{\chapter*{\centering #1}\addcontentsline{toc}{chapter}{#1}}
\newcommand{\spchapter}[1]{
	\begin{center}
		\righthyphenmin62{\sloppy{\textbf{\Large{#1}}}}
	\end{center}
